...
class GetClosestEventsModelTest(unittest.TestCase):
	...
	events = [Event('Single event 1', 'type1', datetime.date(2012, 2, 10)),
	    Event('Single event 2', 'type1', datetime.date(2012, 2, 11)),
	    Event('Single event 3', 'type1', datetime.date(2012, 2, 12))]
